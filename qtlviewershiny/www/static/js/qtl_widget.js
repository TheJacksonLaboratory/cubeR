...
//      let chromosomeURL = `/api/get/${g.PROTOCOL}//churchilllab.jax.org/ensimpl/api/chromosomes`;
        let chromosomeURL = _API_R_BASE + 'chromosomes.json';
        let amp = '';
...
//      let lodPeaksURL = `/api/get/http://10.105.9.102/api/get/http://localhost:8001/lodpeaksall?dataset=${dataSetID}`;
        let lodPeaksURL = _API_R_BASE + dataSetID + '.json';
...
// CCCC
    function downloadDataSets(callback) {
        ...
        //let dataSetsURL = 'http://10.105.9.102/api/get/http://localhost:8001/datasets'
        let dataSetsURL = _API_R_BASE + 'datasets.js'
...
CCCC
    ...
    function selectPhenotype(phenotypeID, dataSetID, covar) {
        ...
        updatePhenotypeSelect2(covar, _correlation, _expression, _lod);
        /*
        $.when( 
            $.ajax({type: 'GET',
          		    url: 'static/data/' + 'correlation' + ".json"}), 
            $.ajax({type: 'GET',
      		    	url: 'static/data/' + 'expression' + ".json"}), 
            $.ajax({type: 'GET',
      		    	url: 'static/data/' + 'lod' + ".json"})
